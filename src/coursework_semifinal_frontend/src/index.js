...
async function hardUpdate() {
    ...
    await coursework_semifinal_backend.instantiate(walletUser);
...
document.querySelector("form").addEventListener("submit", async function(event) {
    ...
    let sex = document.getElementById("city").value;
    if (sex == "Male") { sex = true} else {sex = false};

    const results = await coursework_semifinal_backend.createAccount(name, birthday, phone, sex);
