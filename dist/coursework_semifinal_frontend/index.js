...
/***/ "./src/declarations/coursework_semifinal_backend/coursework_semifinal_backend.did.js":
/*!*******************************************************************************************!*\
  !*** ./src/declarations/coursework_semifinal_backend/coursework_semifinal_backend.did.js ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/coursework_semifinal_backend/index.js":
/*!****************************************************************!*\
  !*** ./src/declarations/coursework_semifinal_backend/index.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "coursework_semifinal_backend": () => (/* binding */ coursework_semifinal_backend),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "idlFactory": () => (/* reexport safe */ _coursework_semifinal_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _coursework_semifinal_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./coursework_semifinal_backend.did.js */ "./src/declarations/coursework_semifinal_backend/coursework_semifinal_backend.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./coursework_semifinal_backend.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_coursework_semifinal_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the coursework_semifinal_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./coursework_semifinal_backend.did.js")._SERVICE>}
 */
 const coursework_semifinal_backend = createActor(canisterId);
...
"use strict";
/*!********************************************************!*\
  !*** ./src/coursework_semifinal_frontend/src/index.js ***!
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_coursework_semifinal_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/coursework_semifinal_backend */ "./src/declarations/coursework_semifinal_backend/index.js");
...
function main() {
    ...
    els.submit_button = document.querySelector('#submitbutton');
...
async function onFormSubmit() {
    ...
    const phone = document.getElementById("salary").value;
    const sex = document.getElementById("city").value;
    if (sex == "male") {
        sex = true;
    } else {sex = false};
  
    const result = await _declarations_coursework_semifinal_backend__WEBPACK_IMPORTED_MODULE_0__.coursework_semifinal_backend.createAccount(name, birthday, phone, sex);
...
async function hardUpdate() {
    ...
    await _declarations_coursework_semifinal_backend__WEBPACK_IMPORTED_MODULE_0__.coursework_semifinal_backend.instantiate(walletUser);
